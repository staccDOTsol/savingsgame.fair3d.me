import {
  ...
  import { useFtxPayLink, useMint, useProvider, useTokenMetadata } from "@strata-foundation/react";
  ...
  export const SwapForm = ({
    ...
    const [lastSet, setLastSet] = useState<"bottom" | "top" | undefined>(undefined);
